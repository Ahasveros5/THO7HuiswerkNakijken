	...
	<%@ page import="java.util.ArrayList" %>
	 ...
	 <%  Person p = (Person)session.getAttribute("selectedStudent");
		if(p!=null){
			...
			out.println("Voornaam: <input type='textfield' disabled=true name='voornaam' value='"+ p.getFirstName() +"'>  </input></br>");
			out.println("Achternaam: <input type='textfield' disabled=true name='achternaam' value='"+ p.getLastName() +"'>  </input></br>");
			out.println("Email: <input type='textfield' disabled=true name='email' value='"+ p.getEmail() +"'>  </input></br>");
			...
			out.println("Klas: <select disabled=true name = 'KlasSelect'>");
			if (klassen!=null){
